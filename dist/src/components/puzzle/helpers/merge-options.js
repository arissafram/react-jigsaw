...
export const mergeOptions = (defaults, options) => {
    ...
    return {
        board: {
            ...
            showBoardSlotOutlines: options.board?.showBoardSlotOutlines ?? defaults.board.showBoardSlotOutlines,
        ...
        puzzle: {
            ...
            refreshButton: {
                className: options.puzzle?.refreshButton?.className ?? defaults.puzzle.refreshButton.className,
                enabled: options.puzzle?.refreshButton?.enabled ?? defaults.puzzle.refreshButton.enabled,
            },
            rowsAndColumns: {
                className: options.puzzle?.rowsAndColumns?.className ?? defaults.puzzle.rowsAndColumns.className,
